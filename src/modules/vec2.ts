...
export function mul(a: Vec2, b: Vec2, out?: Vec2) {
  out = out || vec2(0, 0);
...
export function div(a: Vec2, b: Vec2, out?: Vec2) {
  out = out || vec2(0, 0);
...
export function addN(a: Vec2, k: number, out?: Vec2) {
  out = out || vec2(0, 0);
...
export function subN(a: Vec2, k: number, out?: Vec2) {
  out = out || vec2(0, 0);
...
export function mulN(a: Vec2, k: number, out?: Vec2) {
  out = out || vec2(0, 0);
...
export function divN(a: Vec2, k: number, out?: Vec2) {
  out = out || vec2(0, 0);
...
export function lengthSq(a: Vec2) {
...
export function norm(a: Vec2, out?: Vec2) {
  out = out || vec2(0, 0);
...
// Negates a vector
export function neg(v: Vec2, out?: Vec2) {
  out = out || vec2(0, 0);
...
// Rotates a vector
export function rot(a: Vec2, ang: number, out?: Vec2) {
  out = out || vec2(0, 0);
...
export function mix(a: Vec2, b: Vec2, t: number, out?: Vec2) {
  out = out || vec2(0, 0);
...
export function abs(a: Vec2, out?: Vec2) {
  out = out || vec2(0, 0);
...
export function max(a: Vec2, b: Vec2, out?: Vec2) {
  out = out || vec2(0, 0);
...
export function min(a: Vec2, b: Vec2, out?: Vec2) {
  out = out || vec2(0, 0);
...
export function fract(a: Vec2, out?: Vec2) {
  out = out || vec2(0, 0);
...
export function floor(a: Vec2, out?: Vec2) {
  out = out || vec2(0, 0);
...
export function ceil(a: Vec2, out?: Vec2) {
  out = out || vec2(0, 0);
  out.x = Math.ceil(a.x);
  out.y = Math.ceil(a.y);
  return out;
...
export function round(a: Vec2, out?: Vec2) {
  out = out || vec2(0, 0);
